...
using static OpenIddict.Client.SystemNetHttp.OpenIddictClientSystemNetHttpHandlers.Introspection;

namespace OpenIddict.Client.Tests;

public class OpenIddictClientHandlersIntrospectionResponseTests
{
    ...
    [Fact]
    public async Task ValidateIntrospectionResponseToken_EncryptedTokenIsDecryptedUsingClientKeys()
    {
        // Arrange
        using var provider = CreateProvider(required: true);
    ...
    [Fact]
    public async Task ValidateIntrospectionResponseToken_TokenIssuedToAnotherClientIsRejected()
    {
        // Arrange
        using var provider = CreateProvider(required: true);
