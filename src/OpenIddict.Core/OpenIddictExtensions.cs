...
namespace Microsoft.AspNetCore.Builder {
    public static class OpenIddictExtensions {
        ...
        public static IApplicationBuilder UseOpenIddictCore(
            ...
            // Ensure at least one signing key has been registered.
            if (builder.Options.SigningCredentials.Count == 0) {
                throw new InvalidOperationException("No signing credentials have been registered. Consider adding " +
                                                    "a X.509 certificate using 'builder.UseSigningCertificate()'.");
            }
