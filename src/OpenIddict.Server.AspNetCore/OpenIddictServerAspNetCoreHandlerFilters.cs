...
public static class OpenIddictServerAspNetCoreHandlerFilters
{
    ...
    public sealed class RequireBackchannelAuthenticationEndpointPassthroughEnabled : IOpenIddictServerHandlerFilter<BaseContext>
    {
        ...
        public RequireBackchannelAuthenticationEndpointPassthroughEnabled(IOptionsMonitor<OpenIddictServerAspNetCoreOptions> options)
            => _options = options ?? throw new ArgumentNullException(nameof(options));
    ...
    public sealed class RequireRegistrationEndpointPassthroughEnabled : IOpenIddictServerHandlerFilter<BaseContext>
    {
        ...
        public RequireRegistrationEndpointPassthroughEnabled(IOptionsMonitor<OpenIddictServerAspNetCoreOptions> options)
            => _options = options ?? throw new ArgumentNullException(nameof(options));
