...
public static partial class OpenIddictValidationSystemNetHttpHandlers
{
    public static class Introspection
    {
        ...
        /// </summary>
        public sealed class AttachIntrospectionResponseAcceptHeader : IOpenIddictValidationHandler<PrepareIntrospectionRequestContext>
        {
            /// <summary>
            ...
            public ValueTask HandleAsync(PrepareIntrospectionRequestContext context)
            {
                ...
                if (!context.Options.RequireJsonWebTokenIntrospectionResponses)
                {
                    return ValueTask.CompletedTask;
                }

                // This handler only applies to System.Net.Http requests. If the HTTP request cannot be resolved,
                // this may indicate that the request was incorrectly processed by another validation stack.
        ...
        /// </summary>
        public sealed class ExtractIntrospectionTokenHttpResponse : IOpenIddictValidationHandler<ExtractIntrospectionResponseContext>
        {
            /// <summary>
            /// Gets the default descriptor definition assigned to this handler.
            /// </summary>
            public static OpenIddictValidationHandlerDescriptor Descriptor { get; }
                = OpenIddictValidationHandlerDescriptor.CreateBuilder<ExtractIntrospectionResponseContext>()
                    .AddFilter<RequireHttpUri>()
