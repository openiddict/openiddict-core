    ...
    public async Task Execute(IJobExecutionContext context)
    {
        ...
        try
        {
            ...
            if (!_options.CurrentValue.DisableTokenPruning)
            {
                ...
                var threshold = _options.CurrentValue.GetUtcNow() - _options.CurrentValue.MinimumTokenLifespan;
            ...
            if (!_options.CurrentValue.DisableAuthorizationPruning)
            {
                ...
                var threshold = _options.CurrentValue.GetUtcNow() - _options.CurrentValue.MinimumAuthorizationLifespan;
