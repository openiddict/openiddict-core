...
public static partial class OpenIddictClientWebIntegrationHandlers
{
    ...
    public class AttachNonStandardClientAssertionTokenClaims : IOpenIddictClientHandler<ProcessAuthenticationContext>
    {
        ...
        public ValueTask HandleAsync(ProcessAuthenticationContext context)
        {
            ...
            {
                var settings = context.Registration.GetProviderSettings<OpenIddictClientWebIntegrationSettings.Apple>() ??
                    throw new InvalidOperationException(SR.FormatID0330(Providers.Apple));
    ...
    public class AttachTokenRequestNonStandardClientCredentials : IOpenIddictClientHandler<ProcessAuthenticationContext>
    {
        ...
        public ValueTask HandleAsync(ProcessAuthenticationContext context)
        {
            ...
            // private_key_jwt and a event handler is responsible for populating the client_secret
