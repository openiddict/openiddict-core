                                                                          ...
                                                                          IValidateOptions<OpenIddictClientOptions>
{
    ...
    /// </summary>
    /// <remarks>
    /// This method is automatically invoked for static registrations. Dynamic registrations returned by an
    /// <see cref="IOpenIddictClientRegistrationProvider"/> must call it (once per registration instance)
    /// and <see cref="ValidateProvider(OpenIddictClientRegistration)"/> before being returned.
    /// </remarks>
