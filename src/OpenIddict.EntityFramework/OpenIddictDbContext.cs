...
namespace OpenIddict {
    /// <summary>
    /// Base class for the Entity Framework database context used for OpenIddict.
    /// </summary>
    ...
    /// <typeparam name="TUser">The type of user objects.</typeparam>
    /// <typeparam name="TRole">The type of role objects.</typeparam>
    /// <typeparam name="TApplication">The type of application objects.</typeparam>
    /// <typeparam name="TAuthorization">The type of authorization objects.</typeparam>
    /// <typeparam name="TScope">The type of scope objects.</typeparam>
    ...
    public class OpenIddictDbContext<TUser, TRole, TApplication, TAuthorization, TScope, TToken, TKey> : IdentityDbContext<TUser, TRole, TKey>
        ...
        /// <summary>
        /// Gets or sets the <see cref="DbSet{TEntity}"/> of applications.
        /// </summary>
        public DbSet<TApplication> Applications { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="DbSet{TEntity}"/> of authorizations.
        /// </summary>
        public DbSet<TAuthorization> Authorizations { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="DbSet{TEntity}"/> of scopes.
        /// </summary>
